...
TEST_CASE( "Index tuple basics", "[IndexTuple]" ) {
  ...
  REQUIRE_NOTHROW(dynamic_index_tuple.set_value<2>(42));
  REQUIRE(dynamic_index_tuple.get<2>() == 42);
  
  IndexTuple<StaticIndex<1>,DynamicIndex,StaticIndex<3>,DynamicIndex> mixed_index_tuple;
  REQUIRE_NOTHROW(mixed_index_tuple.set_value<1>(4));
  REQUIRE_NOTHROW(mixed_index_tuple.set_value<3>(2));
  ...
  static_assert(decltype(static_index_tuple * static_index_tuple)::static_get<2>() == 9, "compile time evaluation");
  static_assert(decltype(static_index_tuple + static_index_tuple)::static_get<2>() == 6, "compile time evaluation");
  static_assert(decltype(static_index_tuple * mixed_index_tuple)::static_get<2>() == 9, "compile time evaluation");
  static_assert(decltype(static_index_tuple + mixed_index_tuple)::static_get<2>() == 6, "compile time evaluation");
  ...
  static_assert( decltype( mixed_index_tuple.slice<0, 2>() * static_index_tuple.slice<2, 4>() )::static_get<0>() == 3, "compile time evaluation");
}
